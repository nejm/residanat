...
function _enddoc()
{
    ...
    {
        $header=array('convocation','cin','Nom & Prénom','Moyenne');
        ...
        foreach($data as $row)
        {
            $this->Cell($w[0],6,$row->num,'LR');
            $this->Cell($w[1],6,$row->cin,'LR');
            $this->Cell($w[2],6,$row->nom,'LR',0,'R');
            $this->Cell($w[3],6,$row->moyenne,'LR',0,'R');
            $this->Ln();
        }
